window.askCharacter = function() {
    ...
    let defaultAnswers = [
        "Мой код анализирует эти символы... Расскажи подробнее.",
        "В моих бесконечных архивах пока нет точного ответа на это. Задай другой вопрос.",
        "Я слышу твой стук по клавишам. Это успокаивает. Спроси меня о коде или о мире.",
        "Твои слова интересны. Но помни: я здесь, пока ты смотришь на меня."
    ];
